...
/**
 * Facade for the Temporal Convector workflow.
 *
...
class manager {
    ...
    /**
     * Build the data needed by the Temporal Convector page.
     *
    ...
    public function generate_normalized_archive(stdClass $offlinequiz): array {
        ...
        if ($result === null) {
            return [
                'success' => false,
                'errors' => [get_string('error_pdf_generation', 'local_offlinequizaddons')],
            ];
        }
