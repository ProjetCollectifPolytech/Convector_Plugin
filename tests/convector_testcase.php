...
/**
 * Shared PHPUnit fixture helpers for local_convector tests.
 *
 * @package    local_convector
 */
abstract class convector_testcase extends \advanced_testcase {
    /**
    ...
    protected function create_offlinequiz_activity(
        stdClass $course,
        string $name = 'Convector test activity'
    ): array {
        global $DB;
