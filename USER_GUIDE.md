# Convector - User Guide

## Overview

Convector normalizes OfflineQuiz output so every group ends up with the same page count.
...
2. Open the Convector page from the plugin navigation entry.
