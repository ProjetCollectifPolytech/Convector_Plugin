...
$maxlines = [
    ...
    'classes/controller/temporal_controller.php' => 120,
    'classes/controller/temporal_page_presenter.php' => 260,
    'classes/integration/activity_navigation_integration.php' => 190,
    'classes/pdf_generator.php' => 190,
...
$patterns = [
    ...
    [
        'regex' => '/(^|[^>:\\w])header\s*\(/m',
        'message' => 'uses raw header() output',
    ],
    [
        'regex' => '/(^|[^>:\\w])readfile\s*\(/m',
        'message' => 'uses raw readfile() output',
    ],
    [
        'regex' => '/file_put_contents\s*\([^;]+FILE_APPEND/s',
        'message' => 'appends directly to filesystem logs',
    ],
];
...
if (!empty($issues)) {
    fwrite(STDERR, "Convector_Plugin quality guard failed:\n");
...
fwrite(STDOUT, "Convector_Plugin quality guard passed.\n");
