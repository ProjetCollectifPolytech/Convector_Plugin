...
use local_offlinequizaddons\service\question_pdf_document_builder;
use local_offlinequizaddons\service\question_pdf_question_renderer;
use local_offlinequizaddons\service\question_pdf_rendering_data_loader;
use stdClass;
...
abstract class question_pdf_generator_base extends base_generator {
    ...
    public function generate($groupid, $data) {
        ...
        try {
            ...
            debugging(
                'Temporal Convector failed to generate ' . static::class . ' for group ' .
